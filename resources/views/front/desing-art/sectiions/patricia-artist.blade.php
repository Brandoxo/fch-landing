<section class="sm:grid sm:grid-cols-2">
  ...
  <div class="p-8 flex flex-col sm:gap-8 gap-2">
    <div class="sm:p-16 w-full"  data-aos="fade-down">
              ...
              <h1 class="font-bold text-3xl sm:text-5xl text-center text-white">Patricia Fornos</h1>
    </div>
     ...
     <div class="p-6 sm:p-20 flex flex-col h-auto " >
          ...
          <div class="mt-6 " data-aos="zoom-in-left">
            ...
            <div class="m-6 gap-4 grid grid-cols-2 lg:grid-cols-4 text-center">
                    ...
                    <button class="w-full px-2 p-2 hover:bg-salmon  rounded-md text-white bg-blue flex place-content-center gap-2"><img class="w-6" src="{{asset('assets/icons/socials/social-3.svg')}}">Facebook</button>
