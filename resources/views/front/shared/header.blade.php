...
<nav class="z-20 bg-transparent top-0 left-0 w-full transition-all duration-300" id="mainHeader">
...
<nav class=" bg-salmon/80 top-0 left-0 w-full fixed z-50 pointer-events-none transition-opacity duration-300" id="scrollHeader">
    <div class="flex justify-between items-center px-8 md:px-20 lg:px-40 2xl:px-60 py-2 md:py-1 mx-auto z-20">
            <a class="" href="{{ route('home') }}">
              <img class="h-20 hidden md:block" src="{{asset('assets/img/logos/logo-hor.png')}}" alt="Logo Hotel FCH Hotel Navbar">
            </a>
            <ul class="text-white ml-auto md:flex gap-4 hidden font-semibold 2xl:text-xl">
                <li><a href="#"><p>Hoteles</p></li>
                <li><a href="#"><p>Arte y Diseño</p></li>
